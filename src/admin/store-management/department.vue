<template>
  <div class="department">
    <div class="nav-list">
      ...
      <span class="gray-font">Department</span>
    </div>
    <div>
			<div class="nav-head-one">
				<ul class="clear">
					<li class="red-font">Department</li>
				</ul>
			</div>
		</div>
    <div class="body-box">
      <div class="table-head clear">
				<ul class="clear" style="float: left; margin-top: 0;">
					<li>	
						<div class="demo-input-suffix">
						  	...
						  	<el-input v-model="departmentName" placeholder="Please input Department Name" style="width: 250px;"></el-input>
						</div>
					</li>				
				</ul> 
				...
				<div class="add-but">
					<el-button type="danger" @click="openAdd">Add New Department</el-button>
				</div>
			</div>
    ...
    <el-dialog title="Department Info" :close-on-click-modal="false" width="600px" :visible.sync="dialogAddFormVisible" append-to-body>
      <el-form :model="departmentForm" ref="departmentForm" class="dislog" :rules="rules">
        <el-form-item label="Department Name:" prop="name" :label-width="formLabelWidth">
          <el-input v-model="departmentForm.name" autocomplete="off" style="width: 80%;"></el-input>
        </el-form-item>
        <el-form-item label="Description:" prop="description" :label-width="formLabelWidth">
          <el-input v-model="departmentForm.description" autocomplete="off" style="width: 80%;"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogAddFormVisible=false">Cancel</el-button>
        <el-button type="danger" @click="submitForm('departmentForm')">OK</el-button>
      </div>
    </el-dialog>
  ...
  export default{
    ...
    methods: {
      ...
      getTableData() {
        ...
        return this.$axios.get('/v1/department', {params: params})
          .then((res) => {
      ...
      openDelete(row) {
        this.$confirm('Delete department will can not be rollback, Continue to delete?', 'Confirm', {
          confirmButtonText: 'Confirm',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
          this.loading = true
          this.$axios.delete('/v1/department', {
            params: {
              departmentId: row.id
            }
          })
