	...
	<div class="report">
		...
		<div>
			<div class="nav-head-one">
				<ul class="clear">
					<li class="red-font">High BOH Report</li>
				</ul>
			</div>
		</div>
		...
		<div class="table-body" style="word-wrap:break-word;">	
			<template>				
			  <el-table ref="multipleTable" v-loading="loading" :data="tableData" tooltip-effect="dark" border :header-cell-style="tableHeaderColor">			    			    
			    ...
			    <el-table-column prop="boh" label="Sum of BOH" min-width="100">
			    </el-table-column>	
			    <el-table-column prop="build" label="Sum of Build-To" min-width="100">
			    </el-table-column>			    		    
			  </el-table>
			    <el-pagination
...
export default{
	...
	methods:{	
		...
		getTableData(){
			...
			this.$axios.get('/v1/report/highBOHReport',{params: parm})
